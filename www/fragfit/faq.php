...
<body>
	...
	<div id="content" class="content">
		...
		<br>The user has to upload a protein and a cryo-EM density map, specify the sequence of the destined
		...
		<h4>I get no results, what might be the problem?</h4><br>
			...
			loops can be found. Try to extend the loop search by one amino acid in C- or N-terminal direction.
		...
		<br>FragFit supports MRC and CCP4 (MAP) file formats.
        </div>
